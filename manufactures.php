			...
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title"> 
						<span class="icon"><a href="form_manufacture.php"><i class="icon-plus"></i></a></span>
						<h5>Nhà sản xuất</h5>
					</div>
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<?php 
								...
								$limit = 10;
								$table = 'manufactures';
								$manufactures = $db->paging($current_page, $limit, $table);

								foreach ($manufactures as $value) {
									echo "<tr>";
									echo "<td>".$value['manu_ID']."</td>";
									echo "<td>".$value['manu_name']."</td>";
									echo "<td><img src='public/images/".$value['manu_img']."' style='width:100px'></td>";
									echo "<td>";
									echo "<a href='form_manufacture.php?manufacture=".$value['manu_ID']."' class='btn btn-success btn-mini'>Chỉnh sửa</a>";
									
									echo "<a href='delete.php?manu_id=".$value['manu_ID']."' class='btn btn-danger btn-mini'>Xóa</a>";
									echo "</td>";
									echo "</tr>";
								}
							 ?>
